...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		lblNewLabel_4.setBounds(25, 261, 120, 14);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Total Cost Of The Room (Rs) : ");
		lblNewLabel_5.setBounds(25, 302, 180, 14);
			...
			public void actionPerformed(ActionEvent e) {
				...
				Conn c = new Conn();
                            ...
                            try{
                                ...
                                String paid = "";
                                 paid = txt_Time.getText();
                                 txt_Payment.setText/*(Integer.toString*/(total);
