...
public class Reception extends JFrame {
	...
	public Reception(){
        ...
        setBounds(260, 100, 850, 570);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelManagementSystem/Icons/recept.jpg"));
                Image i3 = i1.getImage().getScaledInstance(650, 600,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(280,30,500,470);
                add(l1);
